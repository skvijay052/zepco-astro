...
export const PILLARS = [
  { title: "Engineering Depth", desc: "A multidisciplinary team spanning power electronics, propulsion, embedded systems and system integration." },
  { title: "End-to-End Development", desc: "From concept, simulation and design to validation, manufacturing and lifecycle support." },
  { title: "Indigenous Engineering", desc: "Designed and manufactured in India by a leadership team with extensive international experience." },
  { title: "Mission-Critical Applications", desc: "Trusted across aerospace, defence, industrial, mobility and energy platforms." },
  { title: "Long-Term Partnership", desc: "Supporting customers from early concept through production and lifecycle." },
];
...
export const STORIES = [
  {
    tag: "Case Study",
    href: undefined as string | undefined, title: "Engineering a 40 kW Indigenous Drone Propulsion Platform",
    img: "photo-1508614999368-9260051292e5",
    date: "2024"
  },
  {
    tag: "Engineering",
    href: undefined as string | undefined, title: "Designing Reliable IP67 Power Electronics for Harsh Environments",
    img: "photo-1581091226825-a6a2a5aee158",
    date: "2024"
  },
  {
    tag: "Milestone",
    href: undefined as string | undefined, title: "Powering the World's Highest-Altitude Heavy-Lift Drone Mission",
    img: "photo-1446776877081-d282a0f896e2",
    date: "2023"
  },
];
